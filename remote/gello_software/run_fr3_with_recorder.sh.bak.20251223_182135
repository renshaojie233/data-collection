#!/bin/bash
# Enhanced version of run_fr3_real_ros2.sh with integrated recorder/replay functionality
# This script maintains all original functionality while adding recording and replay features
...
echo ""
echo "============================================================"
echo "GELLO -> Franka FR3 (ROS2) with Recorder/Replay"
echo "============================================================"
if [ -n "$ROBOT_IP" ]; then
...
# Launch recorder and replay nodes
echo ""
echo "============================================================"
echo "Starting Recorder & Replay System"
echo "============================================================"

RECORDER_DIR="$SCRIPT_DIR/franka_recorder"
cd "$RECORDER_DIR"

echo "Launching recorder node..."
python3 recorder_node.py &
PID_RECORDER=$!

echo "Launching replay node..."
python3 replay_node.py &
PID_REPLAY=$!

sleep 1
echo "Launching control GUI..."
...
cleanup() {
    ...
    kill "$PID_GUI" "$PID_RECORDER" "$PID_REPLAY" 2>/dev/null || true
...
echo "============================================================"
echo "System Ready!"
echo "Use the GUI to control recording and replay."
